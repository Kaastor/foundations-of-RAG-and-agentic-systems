# Chapter 11: Prompt assembly and context packing

## Chapter concepts covered

- **Budget-aware context packing** (implemented in code)
- **Boilerplate trimming and answer-bearing selection** (implemented in code)
- **Contradiction retention** (partially demonstrated)

## What is implemented directly vs documented only

- **Contradiction retention** - partially demonstrated. Conflicts are surfaced as notes rather than silently erased.
