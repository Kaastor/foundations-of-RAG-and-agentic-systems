# Chapter 3: Foundations of information retrieval

## Chapter concepts covered

- **Corpus, query, relevance, ranking vocabulary** (implemented in code)
- **Inverted-index style lexical retrieval** (implemented in code)
- **Classical IR metrics** (implemented in code)
