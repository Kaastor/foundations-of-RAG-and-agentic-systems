# Chapter 27: Reflection, critique, and self-correction

## Chapter concepts covered

- **Correction triggers** (implemented in code)
- **Automatic vs user-mediated correction** (implemented in code)
- **Escalation and bounded correction loops** (implemented in code)
