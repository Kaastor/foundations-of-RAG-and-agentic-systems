# Chapter 23: Planning and task decomposition

## Chapter concepts covered

- **Task classification and coarse planning** (implemented in code)
- **Constraint acquisition before execution** (implemented in code)
- **Replanning after observations** (partially demonstrated)

## What is implemented directly vs documented only

- **Replanning after observations** - partially demonstrated. The controller changes route or follows references after observing retrieved evidence.
