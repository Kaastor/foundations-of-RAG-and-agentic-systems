# Chapter 29: Human-in-the-loop agent workflows

## Chapter concepts covered

- **Clarification requests to end users** (implemented in code)
- **Permission and source-preference confirmation** (partially demonstrated)
- **Reviewer escalation packets** (partially demonstrated)

## What is implemented directly vs documented only

- **Permission and source-preference confirmation** - partially demonstrated. Role-based disclosure is enforced; richer approval workflows are documented.
- **Reviewer escalation packets** - partially demonstrated. Escalation text exists, but reviewer ticketing is simulated rather than integrated.
