# Chapter 22: Tools, APIs, and function calling

## Chapter concepts covered

- **Tool schemas and validation** (implemented in code)
- **Function-calling style structured outputs** (implemented in code)
- **Side-effect safety boundary** (implemented in code)
