# Chapter 5: A minimal end-to-end RAG pipeline

## Chapter concepts covered

- **Offline ingestion and online serving** (implemented in code)
- **Chunk store separated from indexes** (implemented in code)
- **Trace logging and fallback policy** (implemented in code)
