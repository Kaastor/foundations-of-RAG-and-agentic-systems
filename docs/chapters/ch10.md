# Chapter 10: Reranking and relevance refinement

## Chapter concepts covered

- **Second-stage reranking** (implemented in code)
- **Metadata-aware relevance refinement** (implemented in code)
- **Diversity control / deduplication** (partially demonstrated)

## What is implemented directly vs documented only

- **Diversity control / deduplication** - partially demonstrated. Duplicate docs and same-document redundancy are downweighted heuristically.
