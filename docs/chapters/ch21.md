# Chapter 21: What makes a RAG system agentic

## Chapter concepts covered

- **Controller, state, actions, policy** (implemented in code)
- **Workflow vs agentic behavior** (implemented in code)
- **Observable action semantics** (implemented in code)
