# Chapter 24: Retrieval as an action inside agent loops

## Chapter concepts covered

- **Retrieval as a chosen action** (implemented in code)
- **Retry / reformulation / route switch** (implemented in code)
- **Ask the user when scope is missing** (implemented in code)
